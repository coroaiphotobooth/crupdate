...
// Karena logika wrapper di gemini.ts dihapus, prompt di sini harus mandiri (self-contained).
// Prompt harus secara eksplisit menyebutkan "Person in the input image" agar wajah tetap mirip.
...
export const DEFAULT_SETTINGS: PhotoboothSettings = {
  ...
  selectedModel: 'gemini-2.5-flash-image', // Default to Free/Fast model
  overlayImage: null,
  backgroundImage: null,
  autoResetTime: 60,
  adminPin: '1234',
  orientation: 'portrait',
  outputRatio: '9:16', // Default Portrait
  cameraRotation: 0
};
